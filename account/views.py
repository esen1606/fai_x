...
from .serializers import RegistrationSerializer, ActivationSerializer, UserSerializer, ConfirmPasswordSerializer, ResetPasswordSerializer, RegistrationPhoneSerializer
